...
Merged owners are not an operable path. These gaps are recorded facts at the current main; each needs its own authorization. Rows marked **G1-A**, **G1-B**, **G1-C** or **G1-E** record what that slice closed:
