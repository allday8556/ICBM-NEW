...
from app.register.store import ItemSnapshotSpec, RegistrationStore, SnapshotRecord, SnapshotSpec
...
class RegistrationSnapshotBuilder:
    ...
    def freeze(
        ...
        *,
        ...
        assert category is not None and detail is not None  # READY guarantees both
        with self._registrations.transaction() as registrations:
