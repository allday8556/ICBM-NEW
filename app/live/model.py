...
class ProofVerdict(StrEnum):
    """The verdict of one restore drill or one evidence-retention proof (ADR-0018 §7, §8)."""

    PASSED = "PASSED"
    FAILED = "FAILED"


# Why a drill failed. Codes only; a drill never states a guess.
DRILL_SOURCE_MOVED: Final = "DRILL_SOURCE_MOVED"
DRILL_STAGE_MISMATCH: Final = "DRILL_STAGE_MISMATCH"
DRILL_TARGET_UNDETERMINABLE: Final = "DRILL_TARGET_UNDETERMINABLE"
DRILL_REQUIRED_ELEMENT_ABSENT: Final = "DRILL_REQUIRED_ELEMENT_ABSENT"
DRILL_INTEGRITY_FAILED: Final = "DRILL_INTEGRITY_FAILED"
DRILL_SCHEMA_NOT_AT_HEAD: Final = "DRILL_SCHEMA_NOT_AT_HEAD"
DRILL_SCHEMA_MISMATCH: Final = "DRILL_SCHEMA_MISMATCH"
DRILL_ELEMENT_MISMATCH: Final = "DRILL_ELEMENT_MISMATCH"
DRILL_ARTIFACT_MISMATCH: Final = "DRILL_ARTIFACT_MISMATCH"
RETENTION_CHECK_FAILED: Final = "RETENTION_CHECK_FAILED"
# Why a visual acceptance report is not recorded (§9). Codes only; nothing is recorded on refusal.
VISUAL_REPORT_INVALID: Final = "VISUAL_REPORT_INVALID"
VISUAL_CODE_NOT_CURRENT: Final = "VISUAL_CODE_NOT_CURRENT"
VISUAL_SCHEMA_NOT_CURRENT: Final = "VISUAL_SCHEMA_NOT_CURRENT"
VISUAL_COMMIT_NOT_CHECKED_OUT: Final = "VISUAL_COMMIT_NOT_CHECKED_OUT"
VISUAL_REVIEW_MISSING: Final = "VISUAL_REVIEW_MISSING"
