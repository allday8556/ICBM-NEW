...
- **Current milestone:** M4 — canonical Product DB + image pipeline + pricing/readiness foundations ([`ROADMAP.md`](ROADMAP.md) §12, Issue #80). It starts with the PR-A contract ([ADR-0013](docs/adr/0013-m4-canonical-product-contract.md), proposed). No M4 behaviour is implemented yet.
